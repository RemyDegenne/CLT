...
The functions of the form $x \map \sum_{k=1}^n a_k e^{i\langle t_k, x\rangle}$ for $n \in \mathbb{N}$, $a_1, \ldots, a_n \in \mathbb{R}$ and $t_1, \ldots, t_n \in E$ are a star-subalgebra of $\mathcal C_b(E, \mathbb{C})$ (the bounded continuous functions from $E$ to $\mathbb{C}$). 
\end{lemma}
