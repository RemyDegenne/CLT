...
On $K$, the Stone-Weierstrass theorem \texttt{ContinuousMap.starSubalgebra_topologicalClosure_eq_top_of_separatesPoints} gives that a star-subalgebra that separates points is dense.
