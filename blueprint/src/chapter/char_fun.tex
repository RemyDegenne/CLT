...
\begin{proof}\uses{thm:separating_starSubalgebra, lem:separates_points_expPoly, lem:tight_of_tendsto_charFun, lem:cvg_of_separating, lem:tendsto_M_of_tendsto_charFun}
\leanok
