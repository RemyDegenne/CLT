...
\leanok
\lean{ProbabilityTheory.iIndepFun_iff_pi_map_eq_map}
A finite collection of random variables are independent iff their joint law is the product of their respective laws.
\end{lemma}

\begin{proof}
This is proven in PFR: \href{https://teorth.github.io/pfr/docs/PFR/Mathlib/Probability/Independence/Basic.html#ProbabilityTheory.iIndepFun_iff_pi_map_eq_map}{link}.
\end{proof}
...
\uses{lem:taylor_peano}
\end{proof}

\begin{lemma}\label{lem:tendsto_one_plus_div_pow_exp}
\leanok
\lean{tendsto_one_plus_div_pow_exp'}
