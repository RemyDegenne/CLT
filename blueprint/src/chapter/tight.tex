...
\uses{def:tight}
\leanok
\lean{isTightMeasureSet_of_forall_basis_tendsto_limsup}
Let $(\mu_n)_{n \in \mathbb{N}}$ be a sequence of measures on a finite-dimensional normed space $E$. 
Let $b_1, \ldots, b_k$ be a basis of $E$.
If for all $i \in \{1, \ldots, k\}$, $\lim_{r \to +\infty}\mu\{\vert\langle b_i, x\rangle\vert > r\} = 0$, then the set $\{\mu_n \mid n \in \mathbb{N}\}$ is tight.
\end{lemma}
